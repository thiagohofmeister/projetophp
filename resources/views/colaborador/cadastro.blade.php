...
<div class="container">
  <h1>Cadastro de Colaborador</h1>
    <form id="formExemplo" data-toggle="validator" action="/colaborador/add" role="form" method="post">
  <div class="form-group">
    <label for="textColaborador" class="control-label">Colaborador</label>
    <input id="textColaborador" class="form-control" name="nome" placeholder="Digite o Nome do colaborador" type="text" value="{{old('nome')}}">
  </div>
  ...
  <div class="form-group">
    ...
    <input id="textTelefone" class="form-control" name="telefone" placeholder="Digite o numero" type="phone" value="{{old('telefone')}}">
  </div>
  
  <div class="form-group">
    <label for="textDataNas" class="control-label">Data de Nascimento</label>
    <input id="textDataNas" class="form-control" name="data_nascimento" placeholder="Digite a data de nascimento" type="date" value="{{old('data_nascimento')}}">
  </div>
